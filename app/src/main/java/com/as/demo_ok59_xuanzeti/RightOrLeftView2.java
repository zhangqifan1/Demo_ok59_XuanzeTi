...
public class RightOrLeftView2 extends View {
    ...
    public RightOrLeftView2(Context context) {
        this(context, null);
    }

    public RightOrLeftView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public RightOrLeftView2(Context context, AttributeSet attrs, int defStyleAttr) {
